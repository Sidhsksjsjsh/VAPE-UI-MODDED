...
function lib.getUserTag(label,name)
	if type(label) == "string" then
		if label == "get" then
			return {"@None","@everyone","@here","@Fahri","@Asya","@Akbar","@Fania","@Gapryong","@Sauce","@Timmy","@TW O"}
		elseif label == "sent" then
			return name:gsub("@Fahri","<@955564914028716043>"):gsub("@Asya","<@907148919207759912>"):gsub("@Akbar","<@953630026266452008>"):gsub("@Fania","<@896744133450952796>"):gsub("@Gapryong","<@1110937899207237744>"):gsub("@Sauce","<@339544843992825856>"):gsub("@Timmy","<@1067718700112826418>"):gsub("@TW O","<@777152933926010880>")
		end
	end
end
...
function lib.isDeveloper()
	if LocalPlayer.UserId == 3621188307 or LocalPlayer.UserId == 4083898398 or LocalPlayer.UserId == 6016761890 or LocalPlayer.UserId == 1467851908 then
...
function lib:Window(text, preset, closebind)
	...
	lib:runtime(function()
		Title.Text = lib:ColorFonts(text,"White") .. " | " .. lib:ColorFonts(lib:ColorFonts(tonumber(string.split(Stats["Network"]["ServerStatsItem"]["Data Ping"]:GetValueString()," ")[1]) .. "ms (" .. math.floor((LocalPlayer:GetNetworkPing() or 0)) .. "ms) - " .. math.floor(workspace:GetRealPhysicsFPS()) .. "/s - " .. math.round(Stats.GetTotalMemoryUsageMb(Stats)) .. " MB","Bold"),"White")
	end)

...
function lib.getUserTag(label,name)
	if type(label) == "string" then
		if label == "get" then
			return {"@None","@everyone","@here","@Fahri","@Asya","@Akbar","@Fania","@Gapryong"}
		elseif label == "sent" then
			return name:gsub("@Fahri","<@955564914028716043>"):gsub("@Asya","<@907148919207759912>"):gsub("@Akbar","<@953630026266452008>"):gsub("@Fania","<@896744133450952796>"):gsub("@Gapryong","<@1110937899207237744>")
		end
	end
end
